...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string("result_MSDecays_non.root"),
)
...
process.cleanJets.uncSource   = cms.string("FlavorPureBottom")
#process.cleanJets.uncSource   = cms.string("FlavorPureCharm")
#process.cleanJets.uncSource   = cms.string("FlavorPureQuark")
#process.cleanJets.uncSource   = cms.string("FlavorPureGluon")
#process.cleanJets.uncSource   = cms.string("PileUpPtBB")
#process.cleanJets.uncSource   = cms.string("PileUpPtEC")
#process.cleanJets.uncSource   = cms.string("CorrelationGroupIntercalibration")
#process.cleanJets.uncSource   = cms.string("CorrelationGroupMPFInSitu")
#process.cleanJets.uncSource   = cms.string("CorrelationGroupUncorrelated")
